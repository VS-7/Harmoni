...
export const endpoints = {
  ...
  artistCover: (id: string) => `${API_BASE}/library/artists/${id}/cover`,
  ...
  playlistFolder: (id: string) => `${API_BASE}/playlists/${id}/folder`,
  folders: `${API_BASE}/playlist-folders`,
  folder: (id: string) => `${API_BASE}/playlist-folders/${id}`,
